...
namespace DesktopClientLogic.ViewModels
{
        ...
        : NotifyPropertyChanged
    {
        ...
        {
            // add the default _themes
            Themes.Add(new Link {DisplayName = "ciemny", Source = AppearanceManager.DarkThemeSource});
            Themes.Add(new Link {DisplayName = "jasny", Source = AppearanceManager.LightThemeSource});
